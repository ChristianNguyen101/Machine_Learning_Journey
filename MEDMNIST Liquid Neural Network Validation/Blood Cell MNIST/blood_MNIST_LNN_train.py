...
SAVE_OR_LOAD = "NONE" # "SAVE" to save, "LOAD" to load, None to disable
MODEL_PATH = "saved_models/LNN_SAVE_898590"    # path to load/save

# Load in MedMNIST data
blood_info = medmnist.INFO["bloodmnist"]   # BINARY CLASSIFICATION 1x28x28
labels = blood_info['label'] #{'0': 'malignant', '1': 'normal, benign'}
data_file = medmnist.BloodMNIST
...
with torch.no_grad():
    ...
    evaluator = medmnist.Evaluator('bloodmnist', 'test')
