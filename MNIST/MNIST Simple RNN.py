...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun  9 11:55:48 2024
...
model.add(keras.layers.SimpleRNN(256, return_sequences=True, activation='tanh'))
    # 512 nodes and returns output from each timestep
model.add(keras.layers.SimpleRNN(256, activation='tanh'))
